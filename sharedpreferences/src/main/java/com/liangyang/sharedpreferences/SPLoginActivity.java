...
public class SPLoginActivity extends AppCompatActivity {
    ...
    public void saveData(View view) {
        ...
        if (TextUtils.isEmpty(name) || TextUtils.isEmpty(password)) {
            Toast.makeText(SPLoginActivity.this, "用户名和密码不能为空！", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public void readData(View view) {
        ...
        if (TextUtils.isEmpty(userName) && TextUtils.isEmpty(userPassword)) {
            Toast.makeText(SPLoginActivity.this, "数据为空", Toast.LENGTH_SHORT).show();
            return;
        }
        //显示数据
    ...
    public void goToLogin(View view) {
        ...
        if (userName.equals(name) && userPassword.equals(password)) {
            Intent intent = new Intent(SPLoginActivity.this, SuccessActivity.class);
            intent.putExtra("name", userName);
            intent.putExtra("password", userPassword);
            startActivity(intent);
        }else {
            Toast.makeText(SPLoginActivity.this, "用户名或密码不正确，请重新输入...", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void initPopupWindow() {
        //创建popupWindow弹出框
        popupWindow = new PopupWindow(SPLoginActivity.this);
        //弹出窗口的布局
